...
_WalletProvider, one of the features provided in the Mini Dapp SDK, is available to anyone upon request. You can apply through_ [_this link_](https://tally.so/r/w4Y5BB)_._
...
[Go to page to submit SDK T\&C and Kaia Wave >](https://wave.kaia.io/)

## 2. 🧪 Develop Mini Dapp Demo

Please develop your Mini Dapp according to the provided [checklist](../lines-mini-dapp-and-dapp-portal/how-to-build-successful-mini-dapp.md).&#x20;

For any technical questions during development, feel free to contact us through the [Telegram Tech Support Channel](contact-us.md) or via email at `minidapp_review@dappportal.io`.
