...
[미니 Dapp SDK v1.5.0](https://docs.dappportal.io/mini-dapp/mini-dapp-sdk/release-note/v1.5.0) 출시 (Dapp 포털 리브랜딩 지원 소규모 개선)
...
[미니 앱 SDK v1.3.8](mini-dapp/mini-dapp-sdk/release-note/v1.3.8.md)이 출시되었습니다 (Kaia Wallet App의 사소한 버그 수정)

## 2025년 7월 10일

[Mini Dapp SDK v1.3.7](mini-dapp/mini-dapp-sdk/release-note/v1.3.7.md) 출시 (Kaia Wallet App IAB 최적화)

## 2025년 7월 8일

[미니 Dapp SDK v1.3.6](mini-dapp/mini-dapp-sdk/release-note/v1.3.6.md)가 출시되었습니다
...
[미니 앱 SDK v1.3.0](https://app.gitbook.com/o/JrXbEzQU7Die7Vyqr5PZ/s/juuhQ1BuKwYKE7NR6geM/~/changes/222/mini-dapp/mini-dapp-sdk/release-note/v1.3.0) 출시됨 (Bitget Wallet 통합용)

## 2025년 5월 21일

[Reown을 통한 도메인 인증](https://docs.dappportal.io/mini-dapp/mini-dapp-sdk/wallet-provider/domain-verification-via-reown) 가이드가 업데이트되었습니다 (Bitget Wallet 통합을 위해)
...
[성장 경쟁 이벤트 내용](https://docs.dappportal.io/extra-packages/growth-competition)이 업데이트되었습니다

## 2025년 3월 25일

KAIA 결제에 대한 [최소 가격 정책](https://docs.dappportal.io/mini-dapp/mini-dapp-sdk/payment-provider/policy/payment#supported-currencies)이 1 KAIA에서 **0.01 KAIA**로 업데이트되었습니다.
...
[Wallet Connect](https://docs.dappportal.io/mini-dapp/mini-dapp-sdk/wallet-provider#connect-wallet) 흐름 추가됨
