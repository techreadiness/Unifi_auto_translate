...
[미니 Dapp SDK v1.5.0](https://docs.dappportal.io/mini-dapp/mini-dapp-sdk/release-note/v1.5.0) 출시 (Dapp 포털 리브랜딩 지원을 위한 사소한 개선)
...
[미니 댑 SDK v1.4.3](mini-dapp/mini-dapp-sdk/release-note/v1.4.2-and-v1.4.3.md) 출시 (내부 로직 소규모 개선)

## 2025년 8월 19일

[미니 댑 SDK v1.4.1](mini-dapp/mini-dapp-sdk/release-note/#latest-version-v1.4.1) 출시 (OA 팝업 이벤트 추가)

## 2025년 8월 1일

미니 댑 SDK에서 USDT 결제를 지원합니다. (SDK v1.4.0부터)
...
[미니 Dapp SDK v1.3.0](https://app.gitbook.com/o/JrXbEzQU7Die7Vyqr5PZ/s/juuhQ1BuKwYKE7NR6geM/~/changes/222/mini-dapp/mini-dapp-sdk/release-note/v1.3.0) 출시 (Bitget Wallet 통합을 위한)
...
[결제 상태](https://docs.dappportal.io/mini-dapp/mini-dapp-sdk/payment-provider#id-05.-payment-status)에 환불 및 차지백 항목이 포함되도록 업데이트되었습니다.
