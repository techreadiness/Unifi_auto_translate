...
<mark style="color:red;">**Mini Dapps should establish and communicate a clear and fair non-refund policy to users, considering the following principles.**</mark>
...
### Display Purchase Precautions <a href="#dapp-displaypurchaseprecautions.1" id="dapp-displaypurchaseprecautions.1"></a>
...
<mark style="color:red;">**"Text that should be displayed" must appear in "Where it should be displayed"**</mark>
...
* <mark style="color:red;">**"Text that should be displayed" must appear in "Where it should be displayed" in the form of a checkbox.**</mark>
* <mark style="color:red;">**"Information to be provided to the user when clicking View Details" should be available to the user.**</mark>
* <mark style="color:red;">**User must agree to check all checkboxes to activate the Buy/Pay button.**</mark>
