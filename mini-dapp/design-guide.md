...
To indicate that it is a family service of the Mini Dapp ecosystem, please set the browser tab name in the format as`Name | Mini Dapp.`
...
<figure><img src="../.gitbook/assets/Wallet_button_guide.png" alt=""><figcaption></figcaption></figure>

{% file src="../.gitbook/assets/Symbol_Green_512x512.png" %}
