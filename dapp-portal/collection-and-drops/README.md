...
{% file src="../../.gitbook/assets/meta sample (1).csv" %}

## 2. Register NFT Collections <a href="#id-2.-register-nft-collections" id="id-2.-register-nft-collections"></a>
...
## 3. Deploy contract for NFT Collections assigned Mini Dapp  <a href="#id-3.-deploy-contract-for-nft-collections-assigned-mini-dapp" id="id-3.-deploy-contract-for-nft-collections-assigned-mini-dapp"></a>
...
## 4. Set Drops <a href="#id-4.-set-drops" id="id-4.-set-drops"></a>
...
For more information of Airdrop stage, Please find [here >](https://docs.dappportal.io/dapp-portal/collection-and-drops/how-to-mint-nft)
