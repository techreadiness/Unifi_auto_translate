...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/juuhQ1BuKwYKE7NR6geM/unifi-apps/line-integration/line-mini-app
---
...
\| 필드 | 값 | | ----------------------------- | ----------------------------------- | | 서비스 제공 지역 | 대상 서비스 국가 선택 | | 채널 이름 | 유니파이 앱스 이름 입력 | | 채널 설명 | 간단한 서비스 설명 제공 |
