...
* ### Public Stage
  * This stage is available for purchase by any user of the Unfi Apps. The public stage must be placed at the very end of all stages in the Drops, and you can add stages until the public stage begins.
{% endstep %}
{% endstepper %}
